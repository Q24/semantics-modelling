...
def prototype_state():
    ...
    state['test_values_enabled'] = False
...
def prototype_test():
    ...
    state['test_values_enabled'] = True
...
def vhred_debug():
    ...
    # Fill paths here!
    state['train_dialogues'] = "./output/data/ttrain.dialogues.pkl"
    state['test_dialogues'] = "./output/data/ttest.dialogues.pkl"
    state['valid_dialogues'] = "./output/data/tvalid.dialogues.pkl"
    state['dictionary'] = "./output/data/ttrain.dict.pkl"
    state['save_dir'] = "./output/models/"

    state['max_grad_steps'] = 80

    state['valid_freq'] = 200

    state['prefix'] = "largemodel_"
    state['updater'] = 'adam'
    ...
    state['qdim_encoder'] = 7
    state['qdim_decoder'] = 7
    state['sdim'] = 15
    state['rankdim'] = 3
